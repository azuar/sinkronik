      ...
      <div className="client">
        <div className="container text-center">
          ...
          <div className="client-logo justify-content-center align-items-center my-4">
            <div className="d-flex justify-content-center align-items-cente gap-5">
              {clientLogos.map((client, _index) => (
                <img src={`${client}`} alt="" height={84} />
              ))}
            </div>
            <div className="d-flex justify-content-center align-items-cente gap-5 mt-5">
              {clientLogos2.map((client, _index) => (
                <img src={`${client}`} alt="" height={84} />
              ))}
            </div>
          </div>
